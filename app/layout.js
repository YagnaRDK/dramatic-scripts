...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      />
      <meta property="og:image" content="/drs-thumbnail.png" />

      {/* For Twitter */}

      <meta property="twitter:card" content="summary_large_image" />
      <meta property="twitter:url" content="https://dramaticrp.in/" />
      <meta property="twitter:title" content="Dramatic Scripts" />
      <meta
        property="twitter:description"
        content="Empower your GTA 5 roleplay dreams with affordable & custom scripts."
      />
      <meta property="twitter:image" content="/drs-thumbnail.png" />
      <body>{children}</body>
