...
export default function ScriptsLayout({ children }) {
  return (
    <html lang="en">
      ...
      ></meta>
      <meta property="og:title" content="Dramatic Scripts" />
      <meta
        property="og:description"
        content="Empower your GTA 5 roleplay dreams with affordable & custom scripts."
      />
      <meta property="og:image" content="/drs-scripts-thumbnail.png" />

      {/* For Twitter */}

      <meta property="twitter:card" content="summary_large_image" />
      <meta property="twitter:url" content="https://dramaticrp.in/scripts/" />
      <meta property="twitter:title" content="Dramatic Scripts" />
      <meta
        property="twitter:description"
        content="Empower your GTA 5 roleplay dreams with affordable & custom scripts."
      />
      <meta property="twitter:image" content="/drs-scripts-thumbnail.png" />
      <body>{children}</body>
